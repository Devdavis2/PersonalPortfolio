  ...
  render() {
    return (
      <div>
        <nav className="black lime-text !important">
          <div className="nav-wrapper">
            ...
            <a className="brand-logo center" href="#">
              <img className="menulogo" src={DevDavisLogo} />
            </a>
            ...
            <ul id="nav-mobile" className="right hide-on-med-and-down">
              ...
              <li>
                <a className="recommendationbtn" href="/Recommendation">
                  Recommendation
                </a>
              </li>
              <li>
                <a className="contactbtn" href="mailto:dev.davis2@gmail.com">
                  Contact
                </a>
              </li>
            </ul>
        ...
        <ul
          id="slide-out"
          className="sidenav white-text !important blue mobile-menu"
        >
          <li>
            <a href="/">Home</a>
          </li>
          ...
          <li>
            <a href="mailto:dev.davis2@gmail.com">Contact</a>
          </li>
        </ul>
      </div>
    );
